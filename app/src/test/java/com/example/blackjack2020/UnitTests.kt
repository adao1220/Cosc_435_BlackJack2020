...
import com.example.blackjack2020.TipsNTricksActivity.TipsFeed
...
class UnitTests {
    ...
    @Test
    fun `15) Checks for correct URL `() {
       var tips = TipsNTricksActivity()
        var link = tips.getUrl()
        assertThat(link).isEqualTo("https://my-json-server.typicode.com/jcbreen/blackjackJsonRepo/db")
    }
}
